          ...
          <div className='max-w-7xl mx-auto'>
               <div className='mt-12  grid gap-5 grid-cols-1 lg:grid-cols-3'>
                    ...
                    <div>
                         ...
                         <p className='py-3 text-[15px]'> **Airport Transportation Services**  
                         Book hassle-free transportation to and from the airport with our services. Choose from private luxury cars for a premium experience or budget-friendly shared shuttles for cost savings. Whether you prefer comfort or affordability, we provide reliable options to suit your travel needs.</p>
                    </div>
                    <div>
